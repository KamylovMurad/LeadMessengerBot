...
async def get_filters():
    ...
    button5 = types.InlineKeyboardButton('Нутрициологи', callback_data='Нутрициолог')
    button12 = types.InlineKeyboardButton('Косметологи', callback_data='Косметолог')
    ...
    button9 = types.InlineKeyboardButton('Финансисты', callback_data='Финансист')
    button11 = types.InlineKeyboardButton('Маркетологи', callback_data='Маркетолог')
    keyboard.add(button1, button2, button3, button4, button5, button6, button7, button8, button9, button11, button12)
    return keyboard
...
async def get_nums():
    ...
    button7 = types.InlineKeyboardButton('Все категории', callback_data='all_categories')
...
async def user_info_change():
    ...
    button2 = types.InlineKeyboardButton('Изменить фамилию', callback_data='surname')
    button3 = types.InlineKeyboardButton('Изменить номер телефона', callback_data='telephone_number')
    button4 = types.InlineKeyboardButton('Изменить категории для рассылки', callback_data='theme_distribute')
